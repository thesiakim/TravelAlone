...
import com.travelAlone.s20230404.model.dto.mh.InquireDetailPasswordRequestDto;
...
@PostMapping("inquireDetail/PasswordCheck")
@ResponseBody
public boolean inquireDetailPasswordCheck(@LoginUser MemberJpa memberJpa,
										  @RequestBody InquireDetailPasswordRequestDto requestDto,
										  Model model){
	Inquire inquire = mh.detailInquire(requestDto.getGid());

	if (inquire.getG_passwd().equals(requestDto.getGpassword())){
		return true;
	}else {
		return false;
	}
