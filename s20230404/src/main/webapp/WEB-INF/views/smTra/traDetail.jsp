    ...
    <c:forEach items="${traRevList}" var="traRev">
        <tr>
            ...
            <c:if test="${user_id == traRev.member_id }">
                <td style=" padding-left:30px;" ><a href="traRevUpdateForm?travel_id=${traRev.travel_id}&review_id=${traRev.review_id}"><input type="submit" value="수정"></a></td>
                <td style=" padding-left:30px;">
                    <a href="traRevDelete?review_id=${traRev.review_id}" onclick="return confirm('정말로 삭제하시겠습니까?')"><input type="submit" value="삭제"></a>
                </td>
            </c:if>
        </tr>
    </c:forEach>
